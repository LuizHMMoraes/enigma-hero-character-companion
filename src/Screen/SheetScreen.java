...
public class SheetScreen extends JPanel {
	...
	public SheetScreen() {
		...
		JLabel speedLabel = new JLabel(String.valueOf(speed + pc1.getRace().getSpeed()) + " m");
		...
		JLabel passivePerceptionLabel = new JLabel(String.valueOf((modWis + passivePerception) + pc1.ApplySkillProficiencyBonus("Perception")));
